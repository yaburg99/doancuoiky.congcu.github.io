...
if ($result !== false && !empty($result)) {
    // Dữ liệu tồn tại và là một mảng hoặc đối tượng
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
    ...
    // Hiển thị thông báo hoặc xử lý tương ứng nếu không có dữ liệu hoặc dữ liệu không hợp lệ
    echo "Không có dữ liệu chi tiết đơn hàng hoặc dữ liệu không hợp lệ.";
}
?>
